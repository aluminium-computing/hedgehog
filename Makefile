...
gfx:
	i686-elf-gcc $(CFLAGS) -o out/gfx.o gfx/graphics.c
hedgehog:
	i686-elf-ld -melf_i386 -T link.ld -o out/hedgehog.bin out/hedgdt_asm.o out/hedgdt.o out/hedgeboot.o out/hedgehog.o out/kbd.o out/shell.o out/spike_asm.o out/gfx.o out/spike.o

all: core kernel_stuff shell gfx hedgehog
